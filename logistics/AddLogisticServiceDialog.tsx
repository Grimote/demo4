...
interface AddLogisticServiceDialogProps {
  onAddService?: (service: any) => void
}

export function AddLogisticServiceDialog({ onAddService }: AddLogisticServiceDialogProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newService = {
      ...
      orders: Number.parseInt(formData.activeOrders) || 0,
              ...
              <form onSubmit={handleSubmit} className="space-y-8 pb-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <Input
                      id="name"
                      placeholder="Ej: Carga Lima - Arequipa"
                      value={formData.name}
                ...
                <div className="space-y-4">
                  <Label className="text-sm font-medium text-gray-700">Documentos (Opcional)</Label>
                  <div className="space-y-3">
